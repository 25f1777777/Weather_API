...
const apiKey = "d5e0c6113d4490862292759a8d7e99e0";
...
btn.addEventListener('click', async function(){
    ...
    let url =
    `https://api.openweathermap.org/data/2.5/weather?q=${ip}&appid=${apiKey}&units=metric`;

    let forecastUrl =
    `https://api.openweathermap.org/data/2.5/forecast?q=${ip}&appid=${apiKey}&units=metric`;
